...
public class question1redo {
	...
	public static void main(String[] args) {
		...
		//USER FAVORITE TEAM USER INPUT 
			...
			if (favorite.equalsIgnoreCase(team16[i])) {
				teamIsTourn = 1;
				continue;}
			
			if(i==15&& teamIsTourn == 0) {
				System.out.println("Sorry your team in not in the tournament");
				java.awt.desktop.
				System.exit(0);
				}
			}
		...
		for (tournNmbr = 0; tournNmbr <= 19; tournNmbr++) {
			...
			for (int i = 0; i < goals16.length; i += 2) {
				...
				System.out.print(
						"[" + team16[i] + " " + goals16[i] + ":" + goals16[i + 1] + " " + team16[i + 1] + "]" + " ");
			...
			for (int i = 0; i < goals8.length; i += 2) {
				...
				System.out
						.print("[" + team8[i] + " " + goals8[i] + ":" + goals8[i + 1] + " " + team8[i + 1] + "]" + " ");
			}
			System.out.println("");
			...
			for (int i = 0; i < goals4.length; i += 2) {
				...
				System.out
						.print("[" + team4[i] + " " + goals4[i] + ":" + goals4[i + 1] + " " + team4[i + 1] + "]" + " ");
			}
			System.out.println("");
			...
			System.out.print("[" + finals[0] + " " + goalsFinal[0] + ":" + goalsFinal[1] + " " + finals[1] + "]");
			System.out.println("");
			// System.out.println("EVEN" + i);
			...
			/*if (winner.equals(favorite)) {
				System.out
						.println("It took " + tournNmbr + " tournaments (s) of the game for " + winner + " to win!!!");
				break;
			}
